...
class DataFormatArguments:
    ...
    target_column_name: Optional[str] = field(
        default='gold', metadata={"help": "The name of target column name e.g. 'true_strong' or'true_strong_weak'"}
    )
...
class FineTuner():
    ...
    def _load_dataset(self):
        ...
        #data_df = data_df.loc[data_df['added'] != 'true']
